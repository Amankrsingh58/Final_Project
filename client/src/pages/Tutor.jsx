        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            >
              ...
              <option className="hover:cursor-pointer" value="mathematics">Mathematics</option>
            ...
            >
              <option className="hover:cursor-pointer" value="">Any Price</option>
              <option className="hover:cursor-pointer" value="0-25">2000 - 2500/m</option>
              <option className="hover:cursor-pointer" value="25-50">2500 - 3000/m</option>
              <option className="hover:cursor-pointer" value="50-75">3000 - 4000/m</option>
              <option className="hover:cursor-pointer" value="75">5000+ /hr</option>
            </select>
            ...
            <select
              ...
              className="w-full  cursor-pointer px-4 py-2 border text-gray-700 border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
            >
              <option className="hover:cursor-pointer" value="">Any Experience</option>
              <option className="hover:cursor-pointer" value="beginner">Beginner (0-2 years)</option>
              <option className="hover:cursor-pointer" value="intermediate">Intermediate (3-5 years)</option>
              <option className="hover:cursor-pointer" value="expert">Expert (5+ years)</option>
            </select>
          </div>
          ...
          <div className="mt-4 flex justify-end">
            ...
            <button
              ...
              className="px-4  cursor-pointer py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
              Apply Filters
            </button>
          </div>
