      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          ...
          <button
            ...
            className="mt-4  cursor-pointer md:mt-0 flex items-center bg-white px-4 py-2 rounded-md shadow-sm text-gray-700 hover:bg-gray-50 transition-colors"
          >
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            >
              <option className="hover:cursor-pointer" value="">All Subjects</option>
              <option className="hover:cursor-pointer" value="mathematics">Math</option>
              <option className="hover:cursor-pointer" value="physics">Physics</option>
              <option className="hover:cursor-pointer" value="chemistry">Chemistry</option>
              <option className="hover:cursor-pointer" value="biology">Biology</option>
              <option className="hover:cursor-pointer" value="english">English</option>
            </select>
            ...
            >
              <option className="hover:cursor-pointer" value="">All Grades</option>
              <option className="hover:cursor-pointer" value="1">1st Grade</option>
              <option className="hover:cursor-pointer" value="2">2nd Grade</option>
              <option className="hover:cursor-pointer" value="3">3rd Grade</option>
              <option className="hover:cursor-pointer" value="4">4th Grade</option>
              <option className="hover:cursor-pointer" value="5">5th Grade</option>
              <option className="hover:cursor-pointer" value="6">6th Grade</option>
              <option className="hover:cursor-pointer" value="7">7th Grade</option>
              <option className="hover:cursor-pointer" value="8">8th Grade</option>
              <option className="hover:cursor-pointer" value="9">9th Grade</option>
              <option className="hover:cursor-pointer" value="10">10th Grade</option>
              <option className="hover:cursor-pointer" value="11">11th Grade</option>
              <option className="hover:cursor-pointer" value="12">12th Grade</option>
            </select>
          </div>
          ...
          <div className="mt-4 flex justify-end">
            <button
              ...
              className="mr-2  cursor-pointer px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
              Reset Filters
            </button>
            <button
              onClick={() => setShowFilters(false)}
              className="px-4 py-2  cursor-pointer border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
              Apply Filters
            </button>
          </div>
